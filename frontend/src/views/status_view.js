/* ---------- status view ---------- */
    ...
    function renderStatusCards(statsMap) {
      ...
      refs.statusList.innerHTML = '<div class="status-provider-grid">' + entries.map((entry) => {
        const name = entry[0];
        const item = entry[1];
