/* ---------- i18n ---------- */
    ...
    const messages = {
      "zh-CN": {
        ...
        "admin.sessionActiveCopy": "当前设备已保持登录，可直接维护配置与密钥。",
        "admin.sessionActive": "已登录",
        "admin.sessionInactive": "未登录",
        "admin.sessionSummaryStatus": "会话",
        "admin.sessionSummaryStorage": "保存位置",
        "admin.sessionBrowser": "当前浏览器",
      ...
      "en": {
        ...
        "admin.sessionActiveCopy": "This browser stays signed in for direct provider and key management.",
        "admin.sessionActive": "Signed In",
        "admin.sessionInactive": "Signed Out",
        "admin.sessionSummaryStatus": "Session",
        "admin.sessionSummaryStorage": "Stored In",
        "admin.sessionBrowser": "This Browser",
