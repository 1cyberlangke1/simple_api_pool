export const zhMessages = {
  ...
  "admin.importDialogSummary": "支持每行一个，或使用半角逗号分隔；会按当前选中提供商导入。",
  ...
  "group.sectionSummary": "按分组维护逻辑模型、调度策略和目标条目。",
