/* ---------- i18n ---------- */
    ...
    const messages = {
      "zh-CN": {
        ...
        "admin.tabGlobal": "全局",
        "admin.tabProviders": "提供商",
        "admin.tabLogs": "日志",
        "admin.loginTitle": "登录",
        "admin.loginSub": "登录状态保存在当前浏览器。",
        "admin.sessionActive": "已登录",
        "admin.sessionInactive": "未登录",
        ...
        "admin.globalSummaryAdmin": "管理员密钥",
        "admin.globalSummaryClients": "客户端密钥",
        "admin.globalSummaryTokenEst": "Token 估算",
        "admin.configured": "已配置",
        "admin.notConfigured": "未配置",
        "admin.enabled": "开启",
        "admin.disabled": "关闭",
        "admin.clientKeyCount": "{count} 个",
        ...
        "admin.bulkDisableMode": "本次禁用",
        "admin.bulkDisableModeForever": "永久禁用",
        "admin.bulkDisableModeUntil": "按时长禁用",
        "admin.bulkDisableSeconds": "禁用时长（秒）",
        "admin.bulkDisableRange": "可选范围 {min} - {max} 秒",
        "admin.keySelectionSummary": "已选 {selected} / 结果 {result} / 总数 {total}",
        ...
        "provider.keyColumnRef": "Key 引用",
        "provider.keyColumnStatus": "状态",
        "provider.keyColumnFails": "失败",
        "provider.keyColumnDisabledUntil": "禁用至",
        "provider.keyColumnActions": "操作",
      ...
      "en": {
        ...
        "admin.globalSummaryAdmin": "Admin Key",
        "admin.globalSummaryClients": "Client Keys",
        "admin.globalSummaryTokenEst": "Token Estimation",
        "admin.configured": "Configured",
        "admin.notConfigured": "Unset",
        "admin.enabled": "Enabled",
        "admin.disabled": "Disabled",
        "admin.clientKeyCount": "{count} keys",
        ...
        "admin.bulkDisableMode": "Disable This Time",
        "admin.bulkDisableModeForever": "Disable Forever",
        "admin.bulkDisableModeUntil": "Disable For Duration",
        "admin.bulkDisableSeconds": "Disable Duration (s)",
        "admin.bulkDisableRange": "Allowed range {min} - {max} seconds",
        "admin.keySelectionSummary": "Selected {selected} / Results {result} / Total {total}",
        ...
        "provider.keyColumnRef": "Key Ref",
        "provider.keyColumnStatus": "Status",
        "provider.keyColumnFails": "Fails",
        "provider.keyColumnDisabledUntil": "Disabled Until",
        "provider.keyColumnActions": "Actions",
